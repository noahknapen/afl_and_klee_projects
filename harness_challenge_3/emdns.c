...
*/
    ...
    MOVE(request_buffer, sizeof (dns_header_t)); //! request_buffer pointer is adapted here
    ...
    uint8_t len = strlen(request_buffer); //! THIS IS THE ERROR
    printf("strlen(request_buffer) = %d\n", len);
